...
<div class="pagecontainer h-[100%] w-[100%] flex flex-row mobile-content bg-gray-500 dark:bg-gray-500">
    ...
    <div class="mainpagecontainer flex flex-col w-[100%]">
        ...
        <div class="maincontainer w-[100%] h-[100%] grid grid-flow-row md:grid-flow-col bg-gray-100">
            ...
            <div class="secondhalf justify-end py-10 px-10 lg:pr-[250px]">
                ...
                <form action="">
                    ...
                    <div class="mb-6">
                        ...
                        <Textarea id="message" required rows="6" placeholder="Describe what your food item is" bind:value={itemdescription}></Textarea>
                    </div>
                    <div class="mb-10">
