...
<div class="pagecontainer h-[100%] w-[100%] flex flex-row mobile-content">
	...
	<form class="w-[100%] bg-slate-300 dark:bg-pdark-100 overflow-x-hidden flex flex-col">
		<div
			class="storephoto w-[100%] flex-wrap flex items-center justify-around bg-gray-200 dark:bg-orange-900 p-5"
		>
			...
			<div class="flex justify-center flex-col items-center gap-5">
				<div class="intro font-extrabold text-[32px] dark:text-white text-center">
					Store Front Information for {businessname}
				</div>
				<div class="fileuploadingarea">
					<span class="dark:text-white">Upload your store front image here:</span>
					<Fileupload
						accept=".png, .jpg, .jpeg"
						bind:files={storephoto}
						on:click={() => {
						...
						color="white"
						class="border-none m-[1px] bg-white dark:bg-gray-500 dark:text-white"
					></Fileupload>
				</div>
			...
			<div class="firsthalf flex flex-col gap-4">
				...
				<div class="mb-6">
					...
					<Textarea
						...
						placeholder="Description for your store (What you sell, how you do it, etc.)"
					></Textarea>
				</div>
				<div class="mb-6">
		...
		<div class="savebutton flex justify-center mb-10">
			<Button class="" on:click={saveNewInfo} href="/client/dashboard/vendor/store"
