<script>
  ...
  import SpinnerSet from "../../../../SpinnerSet.svelte";
    ...
    function goTo() {
    goto('/client/dashboard/manager/customerreport/report');
  }
  ...
  <div class="page-container min-h-[100vh] overflow-x-hidden bg-white dark:bg-stone-500">
    <div class="header h-20 bg-gray-900 px-6 flex flex-row justify-between"></div>
  
    <main>
      <h1>Welcome to the Customer Order History Page</h1>
      <p>Search for customer:</p>
      <input type="text" bind:value={searchQuery} placeholder="Customer Name/Customer ID" />
      <button on:click={goTo}>Search</button>
    </main>
  </div>
